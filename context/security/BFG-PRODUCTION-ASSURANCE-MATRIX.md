...
| Git history active secret          | `GREEN_EVIDENCE`                    | Gitleaks v8.30.1 scanned 175 reachable commits with 0 findings; TruffleHog v3.96.0 found 0 verified secrets and one deterministic test URI                   | Keep the dedicated history scan in release assurance                                                      |
