...
Status: `PHASE_09_2_FINAL_ASSURANCE` · reconciled evidence date 2026-08-31.
...
| Admin → Owner                      | `GREEN_EVIDENCE`                    | Admin role/invitation/revocation, self-escalation, Owner-target, and ownership-boundary attacks denied; Admin operational Users/Settings/Audit access is allowed by capability | Owner bootstrap remains a high-value server secret; authenticated Production role UAT pending |
...
| Public HTTP scale                  | `750_NOT_PASSING`                   | Profile A application boundaries were reduced (`845ead6`, `1f3839c`, `1697e97`), but latest 750 measured 336.12 RPS at p95 3,147 ms, p99 3,232 ms, 0% errors, 0×429, 0×5xx; 500 aggregate regression passed | Repeated 750 latency stop; sustained 750 and 1,000 not run |
