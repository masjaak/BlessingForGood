...
| Multi-Admin/activity | invitations/appUsers/audit | `/admin/users`, `/admin/audit` | Admin status/read + Owner invite/role/view log | user/audit functions | invitation/access | no private cross-user effect | workspace switch | user/A-01 | Admin/Owner boundary tests | real invitation claim | PARTIAL |
