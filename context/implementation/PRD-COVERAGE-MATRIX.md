...
| Secret Catalog                   | IMPLEMENTED | Hashed admin codes, scoped expiring sessions, rate limiting, private catalog views, canonical order submission | Authenticated owned-order runtime QA; token-only browse intentionally has no customer ownership |
