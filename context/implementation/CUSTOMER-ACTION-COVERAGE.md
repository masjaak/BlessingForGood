...
| `/join` | Kirim permintaan | `joinRequests.submit` | Public admission request | Native validation; submit pending; success/error message | ACTIVE_LOGIC_COMPLETE |
...
| `/catalog` access | Buka katalog | `catalogAccess.unlock` | Signed-in customer; valid access code | Pending disabled; explicit invalid/expired/closed error | ACTIVE_LOGIC_COMPLETE |
