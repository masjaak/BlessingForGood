...
| `public/mockups/admin dashboard 10.png` | Settings | `/admin/settings` | settings page | single-column structured form | save store/contact/payment instructions | loading/empty/saved/error | desktop-first form | local Admin/Owner security/settings tests; current baseline | ADAPTED / KEEP |
