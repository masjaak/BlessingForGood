...
function PersistentAdminInvoices() {
  ...
  if (!adminInvoiceList) return <div className="state-panel">Loading persistent invoices…</div>;
  const ordersWithoutInvoices = state.orders.filter(
...
function AdminInvoices() {
  ...
  return dataSource === "convex" ? <PersistentAdminInvoices /> : <LegacyAdminInvoices />;
}
